...
int main()
{
    ...
    if (APARTADO == 1){
        ...
        for (int _n_experiencias = 0; _n_experiencias<N_MAX_PATRONES; _n_experiencias++){
            ...
            for (int n_patrones_activados=1; n_patrones_activados<N_MAX_PATRONES; n_patrones_activados++) {
                inicializar_nodos(matriz_nodos, -1);
                copiar_matriz(array_patrones[_n_experiencias], matriz_nodos);
                alterar_nodos(matriz_nodos,0.25);
                // ----------------[] Partiendo de a) Una condición aleatoria. []---------------------
                char mu_extension[10];
...
// -- Función ayudante: Lee una matriz de patrones desde un archivo. -- 
...
// -- Función ayudante: Copia una matriz a otra. -- 
...
// -- Función ayudante: Inicializa una matriz a un valor concreto. -- 
// Si el valor es -1, se genera un valor aleatorio.
...
// -- Función ayudante: Altera una matriz en un % de probabilidad. -- 
...
// -- Función ayudante: Imprime una matriz en un archivo. -- 
