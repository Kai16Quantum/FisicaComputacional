...
file_out = "schrodinger_f" # Nombre del fichero de salida (sin extensión)
...
for ys in frames_data[0][1:]:
    ...
    match l:
        case 0: line, = ax.plot(xs, ys, "-", color="blue", linewidth=2)
        case 1: line, = ax.plot(xs, ys, "-", color="blue", linewidth=2)
        case 2: line, = ax.plot(xs, ys, "-", color="red", linewidth=1)
        case other: line, = ax.plot(xs, ys, "-", color="blue", linewidth=1)
